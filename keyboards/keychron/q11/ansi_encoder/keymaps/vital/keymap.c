...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [CMK_BASE] = LAYOUT_91_ansi(
        ...
        MC_3,   KC_CAPS,LCTL_T(KC_A),LSFT_T(KC_R),LALT_T(KC_S),LGUI_T(KC_T),KC_G,  KC_M,  RGUI_T(KC_N),RALT_T(KC_E),RSFT_T(KC_I),RCTL_T(KC_O),  KC_QUOT,           KC_ENT,          KC_HOME,
    ...
    [QWR_BASE] = LAYOUT_91_ansi(
        ...
        MC_3,   KC_CAPS,LCTL_T(KC_A),LSFT_T(KC_S),LALT_T(KC_D),LGUI_T(KC_F),KC_G,  KC_H,  RGUI_T(KC_J),RALT_T(KC_K),RSFT_T(KC_L),RCTL_T(KC_SCLN),KC_QUOT,          KC_ENT,          KC_HOME,
    ...
    [FN1] = LAYOUT_91_ansi(
        ...
        _______,  KC_SCRL,  _______,  _______,  _______,  _______,  _______,   _______,  _______,  KC_UP,    _______,  _______,  _______,    _______,  _______,            _______,
        _______,  _______,  KC_ESCAPE,_______,  _______,  _______,  _______,   _______,  KC_LEFT,  KC_DOWN,  KC_RIGHT, KC_ENTER, _______,              _______,            _______,
        _______,  _______,            _______,  _______,  _______,  _______,   _______,  _______,  _______,  _______,  _______,  _______,              _______,  _______,
        _______,  _______,  _______,  _______,  _______,            _______,                       KC_BSPC,            KC_DEL,   _______,    _______,  _______,  _______,  _______),
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [FN4]   = { ENCODER_CCW_CW(RGB_SAD, RGB_SAI), ENCODER_CCW_CW(RGB_SPD, RGB_SPI)},
};
